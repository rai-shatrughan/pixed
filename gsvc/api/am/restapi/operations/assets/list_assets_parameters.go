...
// ListAssetsParams contains all the bound params for the list assets operation
// typically these are obtained from a http.Request
//
// swagger:parameters listAssets
...
//
// To ensure default values, the struct must have been initialized with NewListAssetsParams() beforehand.
func (o *ListAssetsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	qBasicFieldsOnly, qhkBasicFieldsOnly, _ := qs.GetOK("basicFieldsOnly")
	if err := o.bindBasicFieldsOnly(qBasicFieldsOnly, qhkBasicFieldsOnly, route.Formats); err != nil {
		res = append(res, err)
	}
...
func (o *ListAssetsParams) bindIfNoneMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
// bindBasicFieldsOnly binds and validates parameter BasicFieldsOnly from query.
func (o *ListAssetsParams) bindBasicFieldsOnly(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewListAssetsParams()
		return nil
	}

	value, err := swag.ConvertBool(raw)
	if err != nil {
		return errors.InvalidType("basicFieldsOnly", "query", "bool", raw)
	}
	o.BasicFieldsOnly = &value

	return nil
}

// bindFilter binds and validates parameter Filter from query.
func (o *ListAssetsParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAssetsParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAssetsParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAssetsParams) bindSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ListAssetsParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
