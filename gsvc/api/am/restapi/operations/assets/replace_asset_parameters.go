...
// ReplaceAssetParams contains all the bound params for the replace asset operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceAsset
...
//
// To ensure default values, the struct must have been initialized with NewReplaceAssetParams() beforehand.
func (o *ReplaceAssetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceAssetParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceAssetParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAssetParams) validateID(formats strfmt.Registry) error {
...
func (o *ReplaceAssetParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceAssetParams()
		return nil
	}
