...
// SaveAssetFileAssignmentParams contains all the bound params for the save asset file assignment operation
// typically these are obtained from a http.Request
//
// swagger:parameters saveAssetFileAssignment
...
//
// To ensure default values, the struct must have been initialized with NewSaveAssetFileAssignmentParams() beforehand.
func (o *SaveAssetFileAssignmentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SaveAssetFileAssignmentParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *SaveAssetFileAssignmentParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SaveAssetFileAssignmentParams) validateID(formats strfmt.Registry) error {
...
func (o *SaveAssetFileAssignmentParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewSaveAssetFileAssignmentParams()
		return nil
	}
...
func (o *SaveAssetFileAssignmentParams) bindKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SaveAssetFileAssignmentParams) validateKey(formats strfmt.Registry) error {
