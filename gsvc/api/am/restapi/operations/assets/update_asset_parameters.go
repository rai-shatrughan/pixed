...
// UpdateAssetParams contains all the bound params for the update asset operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateAsset
...
//
// To ensure default values, the struct must have been initialized with NewUpdateAssetParams() beforehand.
func (o *UpdateAssetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.AssetUpdatePatch
...
func (o *UpdateAssetParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateAssetParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateAssetParams) validateID(formats strfmt.Registry) error {
...
func (o *UpdateAssetParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewUpdateAssetParams()
		return nil
	}
