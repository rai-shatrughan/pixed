...
func (o *DeleteAssetURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteAssetURL")
	}
...
func (o *DeleteAssetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAssetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAssetURL")
	}
