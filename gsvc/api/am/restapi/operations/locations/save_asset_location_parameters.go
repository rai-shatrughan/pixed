...
// SaveAssetLocationParams contains all the bound params for the save asset location operation
// typically these are obtained from a http.Request
//
// swagger:parameters saveAssetLocation
...
//
// To ensure default values, the struct must have been initialized with NewSaveAssetLocationParams() beforehand.
func (o *SaveAssetLocationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("location", "body", ""))
			} else {
...
func (o *SaveAssetLocationParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *SaveAssetLocationParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SaveAssetLocationParams) validateID(formats strfmt.Registry) error {
...
func (o *SaveAssetLocationParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewSaveAssetLocationParams()
		return nil
	}
