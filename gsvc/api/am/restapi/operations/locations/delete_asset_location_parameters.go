...
// DeleteAssetLocationParams contains all the bound params for the delete asset location operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteAssetLocation
...
//
// To ensure default values, the struct must have been initialized with NewDeleteAssetLocationParams() beforehand.
func (o *DeleteAssetLocationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteAssetLocationParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAssetLocationParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAssetLocationParams) validateID(formats strfmt.Registry) error {
...
func (o *DeleteAssetLocationParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteAssetLocationParams()
		return nil
	}
