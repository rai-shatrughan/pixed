...
// DeleteAssetTypeParams contains all the bound params for the delete asset type operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteAssetType
...
//
// To ensure default values, the struct must have been initialized with NewDeleteAssetTypeParams() beforehand.
func (o *DeleteAssetTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteAssetTypeParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAssetTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAssetTypeParams) validateID(formats strfmt.Registry) error {
...
func (o *DeleteAssetTypeParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteAssetTypeParams()
		return nil
	}
