...
// UpdateAssetTypeVariableParams contains all the bound params for the update asset type variable operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateAssetTypeVariable
...
//
// To ensure default values, the struct must have been initialized with NewUpdateAssetTypeVariableParams() beforehand.
func (o *UpdateAssetTypeVariableParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.VariableUpdateMap
...
func (o *UpdateAssetTypeVariableParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateAssetTypeVariableParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateAssetTypeVariableParams) validateID(formats strfmt.Registry) error {
...
func (o *UpdateAssetTypeVariableParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewUpdateAssetTypeVariableParams()
		return nil
	}
