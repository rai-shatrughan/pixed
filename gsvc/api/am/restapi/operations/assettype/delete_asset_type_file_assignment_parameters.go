...
// DeleteAssetTypeFileAssignmentParams contains all the bound params for the delete asset type file assignment operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteAssetTypeFileAssignment
...
//
// To ensure default values, the struct must have been initialized with NewDeleteAssetTypeFileAssignmentParams() beforehand.
func (o *DeleteAssetTypeFileAssignmentParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteAssetTypeFileAssignmentParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAssetTypeFileAssignmentParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAssetTypeFileAssignmentParams) validateID(formats strfmt.Registry) error {
...
func (o *DeleteAssetTypeFileAssignmentParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteAssetTypeFileAssignmentParams()
		return nil
	}
...
func (o *DeleteAssetTypeFileAssignmentParams) bindKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAssetTypeFileAssignmentParams) validateKey(formats strfmt.Registry) error {
