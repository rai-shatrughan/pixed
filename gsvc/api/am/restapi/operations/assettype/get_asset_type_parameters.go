...
// GetAssetTypeParams contains all the bound params for the get asset type operation
// typically these are obtained from a http.Request
//
// swagger:parameters getAssetType
...
//
// To ensure default values, the struct must have been initialized with NewGetAssetTypeParams() beforehand.
func (o *GetAssetTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAssetTypeParams) bindIfNoneMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAssetTypeParams) bindExploded(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAssetTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAssetTypeParams) validateID(formats strfmt.Registry) error {
...
func (o *GetAssetTypeParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAssetTypeParams()
		return nil
	}
