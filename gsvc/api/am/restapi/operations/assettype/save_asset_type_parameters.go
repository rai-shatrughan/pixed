...
// SaveAssetTypeParams contains all the bound params for the save asset type operation
// typically these are obtained from a http.Request
//
// swagger:parameters saveAssetType
...
//
// To ensure default values, the struct must have been initialized with NewSaveAssetTypeParams() beforehand.
func (o *SaveAssetTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SaveAssetTypeParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *SaveAssetTypeParams) bindIfNoneMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SaveAssetTypeParams) bindExploded(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SaveAssetTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *SaveAssetTypeParams) validateID(formats strfmt.Registry) error {
...
func (o *SaveAssetTypeParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewSaveAssetTypeParams()
		return nil
	}
