...
// GetAspectTypeParams contains all the bound params for the get aspect type operation
// typically these are obtained from a http.Request
//
// swagger:parameters getAspectType
...
//
// To ensure default values, the struct must have been initialized with NewGetAspectTypeParams() beforehand.
func (o *GetAspectTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAspectTypeParams) bindIfNoneMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAspectTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAspectTypeParams) validateID(formats strfmt.Registry) error {
...
func (o *GetAspectTypeParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAspectTypeParams()
		return nil
	}
