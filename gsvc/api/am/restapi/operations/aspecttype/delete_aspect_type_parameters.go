...
// DeleteAspectTypeParams contains all the bound params for the delete aspect type operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteAspectType
...
//
// To ensure default values, the struct must have been initialized with NewDeleteAspectTypeParams() beforehand.
func (o *DeleteAspectTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteAspectTypeParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteAspectTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteAspectTypeParams) validateID(formats strfmt.Registry) error {
...
func (o *DeleteAspectTypeParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteAspectTypeParams()
		return nil
	}
