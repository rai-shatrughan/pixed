...
// UpdateAspectTypeParams contains all the bound params for the update aspect type operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateAspectType
...
//
// To ensure default values, the struct must have been initialized with NewUpdateAspectTypeParams() beforehand.
func (o *UpdateAspectTypeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.AspectTypePatch
...
func (o *UpdateAspectTypeParams) bindIfMatch(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateAspectTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *UpdateAspectTypeParams) validateID(formats strfmt.Registry) error {
...
func (o *UpdateAspectTypeParams) bindIncludeShared(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewUpdateAspectTypeParams()
		return nil
	}
