...
// NewCreateOrUpdateTimeseriesDataParams creates a new CreateOrUpdateTimeseriesDataParams object
//
// There are no default values defined in the spec.
func NewCreateOrUpdateTimeseriesDataParams() CreateOrUpdateTimeseriesDataParams {

	return CreateOrUpdateTimeseriesDataParams{}
}

// CreateOrUpdateTimeseriesDataParams contains all the bound params for the create or update timeseries data operation
// typically these are obtained from a http.Request
//
// swagger:parameters createOrUpdateTimeseriesData
type CreateOrUpdateTimeseriesDataParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewCreateOrUpdateTimeseriesDataParams() beforehand.
func (o *CreateOrUpdateTimeseriesDataParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateOrUpdateTimeseriesDataParams) bindEntityID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateOrUpdateTimeseriesDataParams) validateEntityID(formats strfmt.Registry) error {
...
func (o *CreateOrUpdateTimeseriesDataParams) bindPropertySetName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
