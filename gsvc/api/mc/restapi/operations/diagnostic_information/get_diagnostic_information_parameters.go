...
// GetDiagnosticInformationParams contains all the bound params for the get diagnostic information operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetDiagnosticInformation
...
//
// To ensure default values, the struct must have been initialized with NewGetDiagnosticInformationParams() beforehand.
func (o *GetDiagnosticInformationParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDiagnosticInformationParams) bindFilter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDiagnosticInformationParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetDiagnosticInformationParams()
		return nil
	}
...
func (o *GetDiagnosticInformationParams) bindSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetDiagnosticInformationParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
